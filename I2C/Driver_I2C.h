...
#define I2C_General_Call_En	1<<7
...
extern void I2C_Master_Transmit(uint8_t SLA_ADD, void *dat, uint8_t num);
extern void I2C_Master_Receive(uint8_t SLA_ADD, void *dat, uint8_t num);
extern void I2C_Slave_Transmit(uint8_t slave_ad, void *dat, uint8_t num);
extern void I2C_Slave_Receive(uint8_t slave_ad, void *dat, uint8_t num);
